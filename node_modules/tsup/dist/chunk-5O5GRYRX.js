...
async function removeFiles(patterns, dir) {
  ...
  const matcher = _picomatch2.default.call(void 0, matchPatterns, {
    dot: true,
    ignore: ignorePatterns,
    windows: process.platform === "win32"
  });
  const files = await new (0, _fdir.fdir)().withFullPaths().filter((file) => matcher(file)).crawl(dir).withPromise();
