...
var loadJson = async (filepath) => {
  try {
    return _chunk5O5GRYRXjs.jsoncParse.call(void 0, await _fs2.default.promises.readFile(filepath, "utf8"));
  } catch (error) {
...
var _picocolors = require('picocolors'); var colors = _interopRequireWildcard(_picocolors); var colors2 = _interopRequireWildcard(_picocolors);
...
var reportSize = (logger, format, files) => {
  ...
  for (const name of filenames) {
    logger.success(
      format,
      `${colors2.bold(padRight(name, maxLength))}${colors2.green(
